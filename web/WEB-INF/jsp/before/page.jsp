        ...
        <div class="col-md-3 column">
            <div class="tabbable" id="tabs-343692">
                <ul class="nav nav-tabs">
                    ...
                    <%--<li>--%>
                        <%--<a href="#panel-607378" data-toggle="tab">分类（专业）</a>--%>
                    <%--</li>--%>
                </ul>
                <div class="tab-content">
                    ...
                    <%--<div class="tab-pane" id="panel-607378">--%>
                        <%--<p>--%>
                        <%--<li>--%>
                            <%--<a href="#">软工</a>--%>
                        <%--</li>--%>
            ...
            <div class="row clearfix">
                <div class="col-md-8 column">
                    <div class="jumbotron well">
                        ...
                        <%--</h1>--%>
                        <%--<p>--%>
                            <%--&lt;%&ndash;<img src="images/before/logo.png">&ndash;%&gt;--%>
                        <%--</p>--%>
                            <img src="images/before/logo.png">
                    </div>
                        ...
                        <div class="post_list ared">
                            <ul>
                                <c:forEach items="${noticelist}" var="nt">
                                    <li><a href="javascript:openNotice('/ch20_war_exploded/selectANotice?id=${nt.id }');">${nt.title }</a></li>
                                </c:forEach>
                            </ul>
                        </div>
                    </div>
                                ...
                                <c:forEach items="${lastedlist }" var="sg">
                                    <li>
                                        <div>
                                            ...
                                            <p class="wz">
                                                <strong><a href="goodsDetail?id=${sg.id }">${sg.mingcheng }</a></strong>
                                                <em>现价:<span>￥${sg.price}</span></em>
                                            </p>
                                        </div>
                                    </li>
                                </c:forEach>
